    ...
    <#elseif section = "form">
        <form id="kc-passwd-update-form" class="${properties.kcFormClass!}" action="${url.loginAction}" method="post">
            ...
            <div class="form-container">
                <div class="form-bear-image-container">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 86.34 91.3" width="128px" height="128px" aria-labelledby="bearIcon_title" role="presentation">
                        <linearGradient id="bearIcon_background" gradientUnits="userSpaceOnUse" x1="43.18" y1="91.3" x2="43.18" y2="4.94"><stop offset="0" stop-color="#cce8f0"></stop><stop offset=".6" stop-color="#8ad0e9"></stop><stop offset=".92" stop-color="#5ac4ed"></stop></linearGradient>
                        <circle cx="43.18" cy="48.12" r="43.18" fill="url(#bearIcon_background)"></circle>
                        ...
                        <g>
                            ...
                            <path d="M38.94 48.36c2-1.04 6.23-1.13 8.48 0" fill="none" stroke="#333" strokeWidth="1.51" strokeLinecap="round" strokeMiterlimit="10"/>
                ...
                <div class="form-group">
                    ...
                    <div class="form-input-container">
                        <input type="password" id="password-new" name="password-new" class="form-input" autofocus autocomplete="new-password" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="form-input-container">
                        <input type="password" id="password-confirm" name="password-confirm" class="form-input" autocomplete="new-password" />
                    </div>
                </div>

                <div id="kc-form-buttons" class="form-actions-container">
                    <#if isAppInitiatedAction??>
                        <button class="button-cancel mr-4" type="submit" name="cancel-aia" value="true">
                            ${msg("doCancel")}
                        </button>
                        <input class="button-submit" type="submit" value="${msg("doSubmit")}" />
                    <#else>
